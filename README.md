...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create nachotime-c30c
  fly apps create nachotime-c30c-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app nachotime-c30c
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app nachotime-c30c-staging
  ```
...
- Create a persistent volume for the sqlite database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly volumes create data --size 1 --app nachotime-c30c
  fly volumes create data --size 1 --app nachotime-c30c-staging
  ```
